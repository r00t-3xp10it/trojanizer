...
## TROJANIZER AND APPL WHITELISTING BYPASSES
    ...
    The follow exercise describes how to use trojanizer and Presetup sfx build-in
    switch to drop and execute a payload using 'certutil' appl whitelisting bypass
    method discover by @subTee and @enigma0x3 ..
    ...
    3º - edit Trojanizer 'settings' file and activate 'single_file_execution'
         SINGLE_EXEC=ON
